...
For workflow management, lifecycle tracking, and project views, see
[Project Management](../development/project-management.md#github-projects-integration).
For setup and configuration, see [GitHub Projects Setup](../setup/github-projects-setup.md).
