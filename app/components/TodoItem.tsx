...
import { useTodoItemGestures } from '../hooks/useTodoItemGestures';
import { sanitizeForAriaLabel } from '../utils/textSanitization';
...
export default function TodoItem({
  ...
  const touchHandlers = useTodoItemGestures({
    todoId: todo.id,
